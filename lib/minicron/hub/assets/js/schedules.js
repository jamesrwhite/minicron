...
(function() {
  var Schedule = {
    ...
    _updateGui: function(parsed_schedule) {
      ...
      this._updateForm(this.formatted(), this.structured());
    },
    ...
    _updateForm: function(formatted_schedule, parsed_schedule) {
      ...
      if (parsed_schedule.type === 'special') {
        $hidden_container.find('input[name="special"]').val(parsed_schedule.special);
      // Otherwise set all the individual parts of the schedules value
      } else {
        $hidden_container.find('input[name="minute"]').val(parsed_schedule.minute);
        $hidden_container.find('input[name="hour"]').val(parsed_schedule.hour);
        $hidden_container.find('input[name="day_of_the_month"]').val(parsed_schedule.day_of_the_month);
        $hidden_container.find('input[name="month"]').val(parsed_schedule.month);
        $hidden_container.find('input[name="day_of_the_week"]').val(parsed_schedule.day_of_the_week);
      }
    },
