// Tweaked version of https://github.com/rburns/ansi-to-html
//
...
var Ansi, STYLES, defaults, extend, toHexString, _i, _results,
  __slice = [].slice;
...
Ansi = (function() {
  ...
  Ansi.prototype.toHtml = function(input) {
    var buf;
  ...
  Ansi.prototype.forEach = function(callback) {
  ...
  Ansi.prototype.pushTag = function(tag, style) {
    if (style == null) {
      style = '';
    }
  ...
  Ansi.prototype.pushStyle = function(style) {
    return this.pushTag("span", style);
  };

  Ansi.prototype.closeTag = function(style) {
    var last;
  ...
  Ansi.prototype.resetStyles = function() {
    var stack, _ref;
  ...
  Ansi.prototype.tokenize = function(text, callback) {
