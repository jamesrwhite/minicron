  ...
  Minicron.ApplicationRoute = Ember.Route.extend({
    actions: {
      error: function(error, transition) {
        ...
        // This feels and almost certainly is a nasty hack
        // var controller = window.Minicron.__container__.lookup('controller:Application');
        // controller.set('code', error.status);
        // controller.set('reason', error.responseJSON.error);
        // this.controllerFor('fatal-error').set('code', 400);
