      ...
      client.addExtension({
        incoming: function(message, callback) {
          ...
          if (message.channel.substr(1, 3) === 'job') {
            ...
            var job_execution_outputs = null;
            ...
            // Is it an output message?
              ...
              store.find('execution', job_execution_id).then(function(execution) {
                ...
                var output = store.push('job_execution_output', {
                ...
                if (job_execution_outputs === null) {
                  job_execution_outputs = execution.get('job_execution_outputs');
                }

                job_execution_outputs.then(function(outputs) {
