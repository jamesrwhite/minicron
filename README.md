...
2. Either [grab the latest](https://github.com/jamesrwhite/minicron/releases/tag/v0.8.1) zip/tarball for your OS and
...
cd minicron
docker build -t minicron-0.8.1 .
docker run -d -p 127.0.0.1:9292:9292 -i -t minicron-0.8.1
