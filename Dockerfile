...
RUN wget https://github.com/jamesrwhite/minicron/releases/download/v0.8.0/minicron-0.8-linux-x86_64.zip
RUN unzip -o minicron-0.8-linux-x86_64.zip

# Add minicron folder to $PATH
ENV PATH=/minicron-0.8-linux-x86_64:$PATH
